...
class ShowWomenProductController extends Controller
{
    /**
    ...
    public function show($id)
    {
       ...
       // $product=Product::where('subcategory_id',$id)->get();
        return view('user/showwomenproducts.index',compact('product','submen','subwomen','subkids'));
    ...
    public function edit($id)
    {
       ...
       // $product=Product::where('subcategory_id',$id)->get();
        return view('user/showwomenproducts.detail',compact('product','product1','product2','submen','subwomen','subkids'));
