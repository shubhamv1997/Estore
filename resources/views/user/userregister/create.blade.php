				...
				<div class="col-md-6" style="border:1px solid gray;padding:20px">
					...
					<div class="login-form-grids" style="width:100%">
						...
						<form action="{{ route('registerstore')}}" method="post">
							@csrf	
							<input type="text" name="first_name" placeholder="First Name..." required=" " style="color:black">
							<input type="text" name="last_name"  placeholder="Last Name..." required=" " style="color:black">
							<br/>
