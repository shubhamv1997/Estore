                ...
                <div class="login-form-grids" style="width:100%;margin:0px">
                    ...
                    <table class="table text-center table-responsive table-bordered table-dark table-striped">
                        <tr>
                            ...
                            <th class="text-center">Product Status by Retailer</th> 
                        ...
                        @foreach(json_decode($orders->products_detail) as $key=>$value)
                            @php
                                ...
                                $userdetail = App\Models\UsersOrder::select()
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                @if($orders->is_order_complete==0)
                                <button  data-toggle="modal" data-target="#completeModal"   class="btn btn-danger">Mark Order As Complete</button>

                                        <div id="completeModal" class="modal fade" role="dialog">
                                            <div class="modal-dialog modal-sm">
                                                <form action="{{route('markordercompletebyadmin')}}" method="post">
                                                    @csrf
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        ...
                                                        <div class="modal-body text-left">
                                                            Do you want to Process Order As Full Complete to user<br/>
                                                            <input type="hidden" name="id" value="{{$orders->id}}"/>                   <br/>                             
                                                            <small>*If you mark order as complete Reseller not allow to change shipping</small>
                                                        </div>
                                                        <div class="modal-footer">
                                ...
                                @else
                                    <h2 class="bg-primary " style="padding:10px;">Order Already Completed</h2>
                                @endif
                            </td>
                        </tr>
