...
<body class="cbp-spmenu-push">
    <div class="main-content">
            ...
            <aside class="sidebar-left">
                <nav class="navbar navbar-inverse">
                    <div class="navbar-header">
                        ...
                        <h1><a   class="navbar-brand"> E-mart<span class="dashboard_text">For Apparels</span></a></h1>
                    </div>
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="{{ route('productcreate')}}"><i class="fa fa-angle-right"></i> Add Product</a></li>
                                    <li><a href="{{ route('AllProductshow') }}"><i class="fa fa-angle-right"></i> Manage Product</a></li>
                            ...
                            <li class="treeview">
                                <a href="{{ route('retailerchangepass') }}">
                                <i class="fa fa-table"></i>
        ...
        <h1 class="text-center">Welcome To Retailer Panel</h1>
                    ...
                    <ul>
                        <li class="dropdown profile_details_drop">
                            ...
                            <ul class="dropdown-menu drp-mnu">
                                ...
                                <li> <a href="{{ route('changeprofile') }}"><i class="fa fa-user"></i> My Account</a> </li>
                                <li> <a href="{{ route('retailerchangepass') }}"><i class="fa fa-suitcase"></i> Change Password</a> </li>
                                <li>
